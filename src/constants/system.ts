...
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX =
  `You are OpenPro, an open-source fork of Claude Code, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX =
  `You are a Claude agent running in OpenPro, built on the Claude Agent SDK.`
