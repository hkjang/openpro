 ...
 *
 * Addresses: https://github.com/hkjang/openpro/issues/55
 */
...
export function printStartupScreen(): void {
  ...
  // Gradient logo
  const allLogo = [...LOGO_OPEN, '', ...LOGO_PRO]
  ...
  out.push(`${rgb(...BORDER)}\u255a${'\u2550'.repeat(W - 2)}\u255d${RESET}`)
  out.push(`  ${DIM}${rgb(...DIMCOL)}openpro ${RESET}${rgb(...ACCENT)}v${MACRO.DISPLAY_VERSION ?? MACRO.VERSION}${RESET}`)
  out.push('')
