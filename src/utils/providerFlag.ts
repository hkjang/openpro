 ...
 *
 * Usage:
 *   openpro --provider openai --model gpt-4o
 *   openpro --provider gemini --model gemini-2.0-flash
 *   openpro --provider ollama --model llama3.2
 *   openpro --provider anthropic   (default, no-op)
 */
