...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/openpro.proto')
...
const openproProto = protoDescriptor.openpro.v1
...
async function main() {
  ...
  const client = new openproProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mOpenPro gRPC CLI\x1b[0m')
