# OpenPro for Non-Technical Users
...
OpenPro lets you use an AI coding assistant with different model providers such as:
...
After you run `openpro`, the CLI should start and wait for your prompt.
