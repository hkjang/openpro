# OpenPro Quick Start for macOS and Linux
...
```bash
npm install -g @hkjang/openpro@latest
```

## 7. Uninstalling OpenPro

```bash
npm uninstall -g @hkjang/openpro
```
